...
- The `<!-- deep-plan-version: 1 -->` marker must be the very first line of the file. `finalize_plan.py` looks for it before mirroring to `~/gits/plan-modes/deep-plan/PLAN.md`.
